...
namespace CSObjectWrapEditor
{
    ...
    public static class Generator
    {
        ...
        private static TemplateRef templateRef = ScriptableObject.CreateInstance<TemplateRef>();
        ...
        private static void GenOne(Type type, Action<Type, LuaTable> type_info_getter, TextAsset templateAsset, StreamWriter textWriter)
        {
        ...
        private static bool hasNotPublicTypeRetOrParam(MethodInfo method)
        {
        ...
        private static void AddToList(List<Type> list, Func<object> get)
        {
            object obj = get();
            if (obj is Type)
            {
